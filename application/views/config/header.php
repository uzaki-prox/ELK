...
<html>
  <head>
    <meta charset="utf-8">
    <title>Ekskul & Lomba | Bayt Al-Hikmah</title>
    <meta name="viewport" content="initial-scale=1, maximum-scale=1, user-scalable=no">
    <base href="<?php echo base_url();?>">
    <link rel="shortcut icon" href="media/logo.png"/>
    <link rel="bookmark" href="media/logo.png"/>
  ...
  <body>
    ...
    <nav role="navigation" class="navbar navbar-custom">
        <div class="container-fluid" style="background-color: #3c8dbc">
          ...
          <img src="media/logo.png" style="height: 50px; margin: 10px 10px 0px 10px;">
          </div>

          <!-- Collect the nav links, forms, and other content for toggling -->
          <h5 style="color: #fff">EKSTRAKULIKULER & LOMBA</h5>
          <h6 style="color: #fff; margin-top: -10px">BAYT AL-HIKMAH</h6>
        </div><!-- /.container-fluid -->
      </nav>
    <!--header-->